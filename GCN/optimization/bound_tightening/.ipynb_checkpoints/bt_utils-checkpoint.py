...
from GCN.optimization.bound_tightening.bt_stats import bounds_mad
...
def run_bound_tightening(weights, input_bounds, output_bounds, bt_procedures, d_max):
    """
    ...
    if bt_procedures:
        for bt in bt_procedures:
            bounds = bt(weights, bounds, d_max)
